...
<figure><img src="@source/NASdocs/使用文档/img/127.0.0.1.png" alt="登陆成功后可以看到NAS共享的文件夹" tabindex="0" loading="lazy"><figcaption>登陆成功后可以看到NAS共享的文件夹</figcaption></figure>
</li>
<li>
...
<figure><img src="@source/NASdocs/使用文档/img/disk.png" alt="映射网络驱动器" tabindex="0" loading="lazy"><figcaption>映射网络驱动器</figcaption></figure>
<figure><img src="@source/NASdocs/使用文档/img/pan.png" alt="直接在中可以看见NAS盘符" tabindex="0" loading="lazy"><figcaption>直接在<code v-pre>此电脑</code>中可以看见NAS盘符</figcaption></figure>
<ul>
<li>或者可以直接为自己的目录创建<code v-pre>快捷方式</code>，之后通过快捷方式就能直接进入目录</li>
</ul>
<figure><img src="@source/NASdocs/使用文档/img/link.png" alt="创建快捷方式" tabindex="0" loading="lazy"><figcaption>创建快捷方式</figcaption></figure>
...
<figure><img src="@source/NASdocs/使用文档/img/user.png" alt="进入控制面板" tabindex="0" loading="lazy"><figcaption>进入控制面板</figcaption></figure>
<figure><img src="@source/NASdocs/使用文档/img/user2.png" alt="管理Windows凭证" tabindex="0" loading="lazy"><figcaption>管理Windows凭证</figcaption></figure>
<figure><img src="@source/NASdocs/使用文档/img/user3.png" alt="删除所有的Windows凭证" tabindex="0" loading="lazy"><figcaption>删除所有的Windows凭证</figcaption></figure>
...
<figure><img src="@source/NASdocs/使用文档/img/yun.png" alt="实验室百度网盘会员账号" tabindex="0" loading="lazy"><figcaption>实验室百度网盘会员账号</figcaption></figure>
<ul>
<li>
<p>下载完成之后，将虚拟机内下载的数据，迁移到NAS内；记得及时清除自己虚拟机内的文件，或者直接下载到NAS内也行；</p>
<figure><img src="@source/NASdocs/使用文档/img/trans.png" alt="直接在Windows里将下载的文件拖到NAS里" tabindex="0" loading="lazy"><figcaption>直接在Windows里将下载的文件拖到NAS里</figcaption></figure>
</li>
</ul>
<div class="hint-container note">
