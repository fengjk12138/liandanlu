...
<figure><img src="@source/NASdocs/deploy/img/server_show.jpg" alt="sever.png" tabindex="0" loading="lazy"><figcaption>sever.png</figcaption></figure>
...
<img src="@source/NASdocs/deploy/img/satahome.png" alt="sata.png" loading="lazy">
<mark>服务器的硬盘位会有提示灯显示硬盘状态，黄色灯为<strong>异常硬盘</strong>，绿色灯为正常硬盘，因此一般只有硬盘故障时，替换黄色灯异常硬盘，否则不要动硬盘，数据安全问题重中之重。</mark>
<img src="@source/NASdocs/deploy/img/satalight.png" alt="satalight.png" loading="lazy">
上图为绿色灯，硬盘正常使用。</p>
</li>
<li>
<p><strong>内存安装</strong>：内存安装是需要考虑位置的，不能随意位置插入，因此不同内存数量需要插得位置也不一样。
RH 2288H V3内存顺序如图
<img src="@source/NASdocs/deploy/img/dimm.png" alt="dimm.png" loading="lazy">
内存编号<strong>从右到左编号</strong>为A，E，I，B，F，J等等。
根据CPU的数量，安装顺序也不同，具体如图，按顺序安装就行。
<img src="@source/NASdocs/deploy/img/dimm2.png" alt="dimm2.png" loading="lazy"></p>
</li>
<li>
<p><strong>后置硬盘仓</strong>：后置硬盘仓的插线可能有人不注意，需要按照手册插入。
线缆如图
<img src="@source/NASdocs/deploy/img/backsata.jpg" alt="backsata.png" loading="lazy">
需要注意两点，</p>
<ul>
...
官方线缆接驳图：
<img src="@source/NASdocs/deploy/img/link.png" alt="link.png" loading="lazy">
<img src="@source/NASdocs/deploy/img/table.png" alt="table.png" loading="lazy"></p>
<ol start="4">
...
<img src="@source/NASdocs/deploy/img/ventoy.png" alt="Ventoy.png" loading="lazy"></p>
</blockquote>
...
<img src="@source/NASdocs/deploy/img/install.png" alt="system.png" loading="lazy"></p>
<blockquote>
<p>注意：系统盘之后无法安装应用或者作为其他数据的存储，因此空间太多是浪费，32G甚至都足够。</p>
</blockquote>
<p>安装完成shell显示如下，可以在其他局域网电脑是用登录
<img src="@source/NASdocs/deploy/img/shell.jpg" alt="shell.png" loading="lazy"></p>
...
<img src="@source/NASdocs/deploy/img/truenaslogin.png" alt="nas.png" loading="lazy"></li>
</ul>
...
<img src="@source/NASdocs/deploy/img/language.png" alt="language.png" loading="lazy"></p>
...
<img src="@source/NASdocs/deploy/img/labpool.png" alt="labpool.png" loading="lazy"></p>
</li>
<li>
...
<img src="@source/NASdocs/deploy/img/usbback.jpg" alt="usbback.png" loading="lazy"></li>
