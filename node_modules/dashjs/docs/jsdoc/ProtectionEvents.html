...
<head>
	...
	<title>dash.js Class: ProtectionEvents</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: ProtectionEvents</h1>
<section>
...
<hr>
<dt>
    <h4 class="name" id="ProtectionEvents"><span class="type-signature"></span>new ProtectionEvents()</h4>
...
<dd>
    ...
    <div class="description">
        <p>Public facing external events to be used when including protection package.<br>
All public events will be aggregated into the MediaPlayerEvents Class and can be accessed<br>
via MediaPlayer.events.  public_ is the prefix that we use to move event names to MediaPlayerEvents.</p>
    </div>
		...
		<ul class="dummy">
			<li>
				<a href="streaming_protection_ProtectionEvents.js.html">streaming/protection/ProtectionEvents.js</a>,
				 <a href="streaming_protection_ProtectionEvents.js.html#sunlight-1-line-35">line 35</a>
			</li>
		</ul>
	</dd>
