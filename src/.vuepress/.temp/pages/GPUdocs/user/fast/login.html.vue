...
<p>这是一个<strong>快速使用</strong>说明，会略去很多功能和细节，更多功能和方法可以参考<a href="../../GPUdocs"><strong>详细文档</strong></a></p>
</div>
...
<figure><img src="@source/GPUdocs/user/img/xhshell1.png" alt="使用Xshell正确设置地址、端口" width="400" height="auto" tabindex="0" loading="lazy"><figcaption>使用Xshell正确设置地址、端口</figcaption></figure>
<figure><img src="@source/GPUdocs/user/img/xhshell2.png" alt="使用Xshell正确设置账密" width="400" height="auto" tabindex="0" loading="lazy"><figcaption>使用Xshell正确设置账密</figcaption></figure>
<hr>
