...
import { ArticleIcon, CategoryIcon, TagIcon, TimelineIcon, } from "@theme-hope/modules/blog/components/icons/index";
import { useArticles, useCategoryMap, useStars, useTagMap, } from "@theme-hope/modules/blog/composables/index";
        ...
        return () => h("div", { class: "blog-info-list" }, [
            ...
            active.value === "article"
                ? h("div", { class: "sticky-article-wrapper" }, [
                    ...
                    h("hr"),
                    h("ul", { class: "sticky-article-list" }, stars.value.items.map(({ info, path }, index) => h(DropTransition, { appear: true, delay: 0.08 * (index + 1) }, () => h("li", { class: "sticky-article" }, h(RouterLink, { to: path }, () => info["t" /* ArticleInfoType.title */]))))),
                ])
