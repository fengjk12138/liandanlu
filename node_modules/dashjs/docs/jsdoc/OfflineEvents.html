...
<head>
	...
	<title>dash.js Class: OfflineEvents</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: OfflineEvents</h1>
<section>
...
<header>
        ...
        OfflineEvents
            ...
            <div class="class-description"><p>These are offline events that should be sent to the player level.</p></div>
...
<hr>
<dt>
    <h4 class="name" id="OfflineEvents"><span class="type-signature"></span>new OfflineEvents()</h4>
		...
		<ul class="dummy">
			<li>
				<a href="offline_events_OfflineEvents.js.html">offline/events/OfflineEvents.js</a>,
				 <a href="offline_events_OfflineEvents.js.html#sunlight-1-line-6">line 6</a>
			</li>
		</ul>
	</dd>
