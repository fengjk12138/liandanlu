import { PageFrontmatter, Page, LocaleConfig, PluginFunction } from '@vuepress/core';
...
interface AutoCatalogOptions {
     ...
     * 页面图标获取器
     */
    iconGetter?: <ExtraPageData extends Record<string | number | symbol, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string | number | symbol, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string | number | symbol, unknown> = Record<never, never>>(page: Page<ExtraPageData, ExtraPageFrontmatter, ExtraPageFields>) => string | null | undefined;
    /**
     * @default 'i'
     */
     ...
     * 页面顺序获取器
     */
    orderGetter?: <ExtraPageData extends Record<string | number | symbol, unknown> = Record<never, never>, ExtraPageFrontmatter extends Record<string | number | symbol, unknown> = Record<string, unknown>, ExtraPageFields extends Record<string | number | symbol, unknown> = Record<never, never>>(page: Page<ExtraPageData, ExtraPageFrontmatter, ExtraPageFields>) => number | null | undefined;
    /**
     * @default 'O'
     */
...
declare const autoCatalogPlugin: (options?: AutoCatalogOptions) => PluginFunction;

export { AutoCatalogOptions, autoCatalogPlugin };
