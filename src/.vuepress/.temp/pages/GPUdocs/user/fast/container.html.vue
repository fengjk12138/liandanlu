...
<figure><img src="@source/GPUdocs/user/img/GPU分配.png" alt="某台服务器的GPU分配示例" width="400" tabindex="0" loading="lazy"><figcaption>某台服务器的GPU分配示例</figcaption></figure>
...
其余几张卡是共享卡，可以协商使用。</p>
<figure><img src="@source/GPUdocs/user/img/nvidia-smi.png" alt="8卡机器里，只能看到4张显卡" height="300" tabindex="0" loading="lazy"><figcaption>8卡机器里，<code v-pre>nvidia-smi</code>只能看到4张显卡</figcaption></figure>
</div></template>
