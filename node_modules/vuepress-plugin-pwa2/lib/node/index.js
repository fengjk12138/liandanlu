...
`)},U=(e={},a=!0)=>n=>{a&&W(e),C(n,v,"2.0.0-beta.61"),n.env.isDebug&&m.info("Options:",e);const{base:i,shouldPrefetch:l=!0}=n.options;e.appendBase&&F(i,e),l===!0&&m.warn('The plugin will register service worker to handle assets, so we recommend you to set "shouldPrefetch: false" in VuePress config file.');const p=B(n,e);return n.options.head=K(e,i,n.options.head),I(n,{id:"hope"}),{name:v,define:()=>({PWA_LOCALES:P({app:n,name:v,default:w,config:e.locales}),SW_FORCE_UPDATE:e.update==="force",SW_PATH:e.swPath||"service-worker.js"}),extendsBundlerOptions:(t,s)=>{A(t,s,["mitt","register-service-worker"]),T(t,s,{path:"/manifest.webmanifest",response:async(r,o)=>(o.setHeader("Content-Type","application/manifest+json"),JSON.stringify(await p)),errMsg:"Unexpected manifest generate error"})},onGenerated:async t=>{await L(t,p),await H(t,e)},clientConfigFile:t=>_(t,e)}};export{w as pwaLocales,U as pwaPlugin};
