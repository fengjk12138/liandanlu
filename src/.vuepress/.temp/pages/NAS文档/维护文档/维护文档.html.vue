...
<img src="@source/NAS文档/维护文档/img/rep1.png" alt="rep1.jpg" loading="lazy"></li>
<li>选择<code v-pre>更换</code>之后，可以选择任意空闲硬盘，<strong>替换后的硬盘需要比原先硬盘大才行</strong>；之后需要等待半天的数据导入，就完成了替换
<img src="@source/NAS文档/维护文档/img/rep2.png" alt="rep2.jpg" loading="lazy"></li>
</ul>
...
<img src="@source/NAS文档/维护文档/img/break.png" alt="break.jpg" loading="lazy"></li>
...
<img src="@source/NAS文档/维护文档/img/replace.png" alt="replace.jpg" loading="lazy"></li>
</ul>
...
<img src="@source/NAS文档/维护文档/img/addvdev.png" alt="addvdev.jpg" loading="lazy"></li>
</ul>
...
<img src="@source/NAS文档/维护文档/img/discon.png" alt="discon.jpg" loading="lazy"></p>
</li>
<li>
<p>在全部硬盘插入新的服务器后，在新的服务器上选择导入存储池即可。
<img src="@source/NAS文档/维护文档/img/import.png" alt="import.jpg" loading="lazy"></p>
</li>
<li>
...
<img src="@source/NAS文档/维护文档/img/public.png" alt="public.jpg" loading="lazy"></p>
...
<img src="@source/NAS文档/维护文档/img/dir.png" alt="dir.jpg" loading="lazy"></li>
<li>权限设置，只有用户本身有读写执行权限，其他人没有任何权限，这样能保证私密性。</li>
</ul>
<p>设置一览图
<img src="@source/NAS文档/维护文档/img/user.png" alt="user.jpg" loading="lazy"></p>
