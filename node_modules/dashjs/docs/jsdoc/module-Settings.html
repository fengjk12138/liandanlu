...
<p>For details please check the samples section and FetchLoader.js.</p></td>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-560">line 560</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">string</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-331">line 331</a>
			</li>
		</ul>
	</dd>
...
<p>That buffered range is likely to have been enqueued for playback. Pruning it causes a flush and reenqueue in WPE and WebKitGTK based browsers. This stresses the video decoder and can cause stuttering on embedded platforms.</p></td>
        ...
        <tr>
                ...
                <td class="name"><code>useChangeTypeForTrackSwitch</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>If this flag is set to true then dash.js will use the MSE v.2 API call &quot;changeType()&quot; before switching to a different track.<br>
Note that some platforms might not implement the changeType functio. dash.js is checking for the availability before trying to call it.</p></td>
        </tr>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-263">line 263</a>
			</li>
		</ul>
	</dd>
...
<p>A value defined in milliseconds representing how log to cache the settings for.</p></td>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-380">line 380</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">boolean</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-552">line 552</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">Array.&lt;string></span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-638">line 638</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt class="name" id="~CmsdAbrSettings">
    <h4 id="~CmsdAbrSettings">CmsdAbrSettings</h4>
...
<table class="props table table-striped">
    ...
    <tbody>
        ...
        <tr>
                ...
                <td class="name"><code>applyMb</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Set to true if dash.js should apply CMSD maximum suggested bitrate in ABR logic.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>etpWeightRatio</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>Sets the weight ratio (between 0 and 1) that shall be applied on CMSD estimated throuhgput compared to measured throughput when calculating throughput.</p></td>
        </tr>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-676">line 676</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt class="name" id="~CmsdSettings">
    <h4 id="~CmsdSettings">CmsdSettings</h4>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Enable or disable the CMSD response headers parsing.</p></td>
        </tr>
...
<span class="param-type"><a href="module-Settings.html#~CmsdAbrSettings">module:Settings~CmsdAbrSettings</a></span>
            ...
            <td class="description last"><p>Sets additional ABR rules based on CMSD response headers.</p></td>
        </tr>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-668">line 668</a>
			</li>
		</ul>
	</dd>
...
<p>Note this will be dispatched regardless of log level.</p></td>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-339">line 339</a>
			</li>
		</ul>
	</dd>
...
<p>For mediaErrorDecode the player will reset the MSE and skip the blacklisted segment that caused the decode error. The resulting gap will be handled by the GapController.</p></td>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-372">line 372</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">number</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-390">line 390</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>Use this parameter to set the minimum and maximum catch up rates, as percentages, for low latency live streams.</p>
...
<p>Valid values for min catch up rate are in the range -0.5 to 0 (-50% to 0% playback rate decrease)</p>
<p>Valid values for max catch up rate are in the range 0 to 1 (0% to 100% playback rate increase).</p>
<p>Set min and max to NaN to turn off live catch up feature.</p>
<p>These playback rate limits take precedence over any PlaybackRate values in ServiceDescription elements in an MPD. If only one of the min/max properties is given a value, the property without a value will not fall back to a ServiceDescription value. Its default value of NaN will be used.</p>
<p>Note: Catch-up mechanism is only applied when playing low latency live streams.</p></td>
        </tr>
...
<p>Note: Catch-up mechanism is automatically applied when playing low latency live streams.</p></td>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-470">line 470</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">boolean</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-243">line 243</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">number</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-684">line 684</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">boolean</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-539">line 539</a>
			</li>
		</ul>
	</dd>
...
<p>Note: It's not type of request.</p></td>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-511">line 511</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">boolean</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-449">line 449</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Overwrite the manifest segments base information timescale attributes with the timescale set in initialization segments</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>enableManifestTimescaleMismatchFix</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>Time in milliseconds before timing out on loading a media fragment.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>manifestRequestTimeout</code></td>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>Time in milliseconds before timing out on loading a manifest.</p>
...
<span class="param-type"><a href="module-Settings.html#~CmcdSettings">module:Settings~CmcdSettings</a></span>
        ...
        <tr>
                ...
                <td class="name"><code>cmsd</code></td>
            

            <td class="type">
            
                
<span class="param-type"><a href="module-Settings.html#~CmsdSettings">module:Settings~CmsdSettings</a></span>
            ...
            <td class="description last"><p>Settings related to Common Media Server Data parsing.</p></td>
        </tr>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-690">line 690</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">number</span>
        ...
        <tr>
                ...
                <td class="name"><code>extendSegmentedCues</code></td>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>Enable/disable patching of segmented cues in order to merge as a single cue by extending cue end time.</p></td>
        </tr>
        ...
        <tr>
                ...
                <td class="name"><code>webvtt</code></td>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>Enables the custom rendering for WebVTT captions. For details refer to the &quot;Subtitles and Captions&quot; sample section of dash.js.<br>
Custom WebVTT rendering requires the external library vtt.js that can be found in the contrib folder.</p></td>
        </tr>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-459">line 459</a>
			</li>
		</ul>
	</dd>
...
In case the MPD uses &lt;SegmentTimeline\ and no segment is found within the DVR window the DVR window is calculated based on the entries in &lt;SegmentTimeline&gt;.</li>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-235">line 235</a>
			</li>
		</ul>
	</dd>
...
<span class="param-type">object</span>
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="core_Settings.js.html">core/Settings.js</a>,
				 <a href="core_Settings.js.html#sunlight-1-line-410">line 410</a>
			</li>
		</ul>
	</dd>
