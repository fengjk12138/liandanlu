...
<head>
	...
	<title>dash.js Class: MediaPlayerModel</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: MediaPlayerModel</h1>
<section>
...
<hr>
<dt>
    <h4 class="name" id="MediaPlayerModel"><span class="type-signature"></span>new MediaPlayerModel()</h4>
...
<dd>
    ...
    <div class="description">
        <p>We use this model as a wrapper/proxy between Settings.js and classes that are using parameters from Settings.js.<br>
In some cases we require additional logic to be applied and the settings might need to be adjusted before being used.</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="streaming_models_MediaPlayerModel.js.html">streaming/models/MediaPlayerModel.js</a>,
				 <a href="streaming_models_MediaPlayerModel.js.html#sunlight-1-line-51">line 51</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id="~_checkMaxPlaybackRate"><span class="type-signature">&lt;inner> </span>_checkMaxPlaybackRate(rate, log)</h4>
...
<dd>
    ...
    <div class="description">
        <p>Checks the supplied max playback rate is a valid vlaue and within supported limits</p>
    </div>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>Supplied max playback rate</p></td>
        </tr>
...
<span class="param-type">boolean</span>
            ...
            <td class="description last"><p>wether to shown warning or not</p></td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="streaming_models_MediaPlayerModel.js.html">streaming/models/MediaPlayerModel.js</a>,
				 <a href="streaming_models_MediaPlayerModel.js.html#sunlight-1-line-103">line 103</a>
			</li>
		</ul>
	</dd>
...
<div class="param-desc">
    <p>corrected max playback rate</p>
</div>
...
<hr>
<dt>
    <h4 class="name" id="~_checkMinPlaybackRate"><span class="type-signature">&lt;inner> </span>_checkMinPlaybackRate(rate, log)</h4>
...
<dd>
    ...
    <div class="description">
        <p>Checks the supplied min playback rate is a valid vlaue and within supported limits</p>
    </div>
...
<span class="param-type">number</span>
            ...
            <td class="description last"><p>Supplied min playback rate</p></td>
        </tr>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="streaming_models_MediaPlayerModel.js.html">streaming/models/MediaPlayerModel.js</a>,
				 <a href="streaming_models_MediaPlayerModel.js.html#sunlight-1-line-80">line 80</a>
			</li>
		</ul>
	</dd>
...
<div class="param-desc">
    <p>corrected min playback rate</p>
</div>
...
<hr>
<dt>
    <h4 class="name" id="~getAbrBitrateParameter"><span class="type-signature">&lt;inner> </span>getAbrBitrateParameter(field, mediaType)</h4>
...
<dd>
    ...
    <div class="description">
        <p>Returns the min,max or initial bitrate for a specific media type.</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="streaming_models_MediaPlayerModel.js.html">streaming/models/MediaPlayerModel.js</a>,
				 <a href="streaming_models_MediaPlayerModel.js.html#sunlight-1-line-184">line 184</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id="~getCatchupMaxDrift"><span class="type-signature">&lt;inner> </span>getCatchupMaxDrift()</h4>
...
<dd>
    ...
    <div class="description">
        <p>Returns the maximum drift allowed before applying a seek back to the live edge when the catchup mode is enabled</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="streaming_models_MediaPlayerModel.js.html">streaming/models/MediaPlayerModel.js</a>,
				 <a href="streaming_models_MediaPlayerModel.js.html#sunlight-1-line-124">line 124</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id="~getCatchupModeEnabled"><span class="type-signature">&lt;inner> </span>getCatchupModeEnabled()</h4>
...
<dd>
    ...
    <div class="description">
        <p>Returns whether the catchup mode is activated via the settings or internally in the PlaybackController</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="streaming_models_MediaPlayerModel.js.html">streaming/models/MediaPlayerModel.js</a>,
				 <a href="streaming_models_MediaPlayerModel.js.html#sunlight-1-line-171">line 171</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id="~getCatchupPlaybackRates"><span class="type-signature">&lt;inner> </span>getCatchupPlaybackRates()</h4>
...
<dd>
    ...
    <div class="description">
        <p>Returns the minimum and maximum playback rates to be used when applying the catchup mechanism<br>
If only one of the min/max values has been set then the other will default to 0 (no playback rate change).</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="streaming_models_MediaPlayerModel.js.html">streaming/models/MediaPlayerModel.js</a>,
				 <a href="streaming_models_MediaPlayerModel.js.html#sunlight-1-line-142">line 142</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id="~getInitialBufferLevel"><span class="type-signature">&lt;inner> </span>getInitialBufferLevel()</h4>
...
<dd>
    ...
    <div class="description">
        <p>Returns the initial buffer level taking the stable buffer time into account</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="streaming_models_MediaPlayerModel.js.html">streaming/models/MediaPlayerModel.js</a>,
				 <a href="streaming_models_MediaPlayerModel.js.html#sunlight-1-line-207">line 207</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id="~getRetryAttemptsForType"><span class="type-signature">&lt;inner> </span>getRetryAttemptsForType(type)</h4>
...
<dd>
    ...
    <div class="description">
        <p>Returns the number of retry attempts for a specific media type</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="streaming_models_MediaPlayerModel.js.html">streaming/models/MediaPlayerModel.js</a>,
				 <a href="streaming_models_MediaPlayerModel.js.html#sunlight-1-line-233">line 233</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id="~getRetryIntervalsForType"><span class="type-signature">&lt;inner> </span>getRetryIntervalsForType(type)</h4>
...
<dd>
    ...
    <div class="description">
        <p>Returns the retry interval for a specific media type</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="streaming_models_MediaPlayerModel.js.html">streaming/models/MediaPlayerModel.js</a>,
				 <a href="streaming_models_MediaPlayerModel.js.html#sunlight-1-line-244">line 244</a>
			</li>
		</ul>
	</dd>
...
<hr>
<dt>
    <h4 class="name" id="~getStableBufferTime"><span class="type-signature">&lt;inner> </span>getStableBufferTime()</h4>
...
<dd>
    ...
    <div class="description">
        <p>Returns the stable buffer time taking the live delay into account</p>
    </div>
...
<dl class="details">
	...
	<dd class="tag-source">
		<ul class="dummy">
			<li>
				<a href="streaming_models_MediaPlayerModel.js.html">streaming/models/MediaPlayerModel.js</a>,
				 <a href="streaming_models_MediaPlayerModel.js.html#sunlight-1-line-221">line 221</a>
			</li>
		</ul>
	</dd>
