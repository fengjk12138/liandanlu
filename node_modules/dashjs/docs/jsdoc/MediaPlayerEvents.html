...
<head>
	...
	<title>dash.js Class: MediaPlayerEvents</title>
...
<div class="row">
	...
	<h1 class="page-title">Class: MediaPlayerEvents</h1>
<section>
...
<hr>
<dt>
    <h4 class="name" id="MediaPlayerEvents"><span class="type-signature"></span>new MediaPlayerEvents()</h4>
...
<dd>
    ...
    <div class="description">
        <p>Public facing external events to be used when developing a player that implements dash.js.</p>
    </div>
		...
		<ul class="dummy">
			<li>
				<a href="streaming_MediaPlayerEvents.js.html">streaming/MediaPlayerEvents.js</a>,
				 <a href="streaming_MediaPlayerEvents.js.html#sunlight-1-line-37">line 37</a>
			</li>
		</ul>
	</dd>
